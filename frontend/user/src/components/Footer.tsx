        ...
        <footer class="footer bg-base-200/60 px-6 py-4">
            <div class="flex w-full flex-wrap items-center justify-between">
                ...
                <aside class="grid-flow-col items-center">
                    <p> ©2025 <span class="link link-hover font-medium" >ModVerse</span> </p>
                </aside>
                <div class="flex h-5 gap-4">
                    <a href="https://github.com/Fyt1108/ModVerse" rel="noreferrer" target="_blank" class="link" aria-label="Github Link">
